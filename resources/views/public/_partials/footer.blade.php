...
<footer class="bg-green-900 text-white" aria-labelledby="footer-heading">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-6 text-center lg:text-start py-10">
            <!-- Logo e descrição -->
            <div class="lg:col-span-3 flex items-center justify-center text-center">
            ...
            <div>
                ...
                <ul class="space-y-1 text-sm">
                    <li><a href="{{ route('home') }}" class="text-green-200 hover:text-white transition-colors block py-1 focus:outline-none focus:text-white">Início</a></li>
                    ...
                    <li><a href="{{ route('fotos') }}" class="text-green-200 hover:text-white transition-colors block py-1 focus:outline-none focus:text-white">Galeria Pré-Conferências</a></li>
            ...
            <div>
                ...
                <ul class="space-y-1 text-sm">
                    ...
                    <li><a href="{{ route('programacao') }}" class="text-green-200 hover:text-white transition-colors block py-1 focus:outline-none focus:text-white">Programação</a></li>
                    <li><a href="{{ route('delegados') }}" class="text-green-200 hover:text-white transition-colors block py-1 focus:outline-none focus:text-white">Delegados</a></li>
                    <li><a href="{{ route('propostas') }}" class="text-green-200 hover:text-white transition-colors block py-1 focus:outline-none focus:text-white">Propostas</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="py-4 text-center lg:text-start border-t border-green-800">
            <div class="flex flex-col sm:flex-row justify-between items-center text-sm space-y-4">
                ...
                <ul class="flex flex-wrap gap-4 text-green-100 text-xs">
                    <li><a href="{{ route('login') }}" class="hover:text-white transition-colors focus:outline-none focus:text-white">Área da Comissão</a></li>
