...
<html>
<head>
    <title>Confirmação de Envio do Atividade</title>
</head>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td align="center" style="padding: 40px 0; background-color: #1E88E5;">
                <h1 style="color: #fff; font-size: 32px; margin: 0;">Atividade Recebido com Sucesso!</h1>
            </td>
        </tr>
        <tr>
            <td align="center" style="padding: 40px; background-color: #ffffff;">
                <p style="font-size: 18px; color: #333;">Olá <strong>{{ $user->name }}</strong>,</p>
                <p style="font-size: 16px; color: #555;">Seu Atividade foi recebido com sucesso.</p>
